...
void Sample_Vizi3D::setupContent() {
    ...
    // Строим игровой мир
    world = std::shared_ptr< Vizi3DWorld >( new Vizi3DWorld( mSceneMgr ) );
    //world->load( "D:/Projects/workspace/ogre3d/Vizi3D/test/data/world/a-10x5x5-water.json" );
    world->load( "D:/Projects/workspace/ogre3d/Vizi3D/test/data/world/b-water-vegetation.json" );
