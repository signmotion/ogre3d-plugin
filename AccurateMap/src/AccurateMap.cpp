...
void Sample_AccurateMap::setupContent() {
    ...
    // Инициализируем и очистим хранилище
    // @todo Вынести во внешний конфиг. JSON?
    const std::string name = "amap";
    const std::string user = "dalion";
    const std::string password = "visor888";
    const std::string url = "127.0.0.1:5984";
    ...
    worldSize = d::size3d_t( 128.0f,  128.0f,  40.0f ) / 5.0f;
