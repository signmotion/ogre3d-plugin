...
*   1 - плюс
*
* @todo fine Вынесено в d:: и задана жёсткая размерность:
*        не удаётся красиво использовать в других классах (из-за шаблона).
*
* @see Doxel
*/
typedef std::bitset< 3 /* макс. размерность докселя */ >  dant_t;
