...
void PhysicsPort::bodyForceAndTorqueCallback(
    ...
    */
    ...
    const size_t K = 10;
    humanInWorld->setCurrent(
        boost::assign::list_of
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[0])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[1])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[2])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[3])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[4])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[5])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[6])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[7])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[8])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[9])
            (d::coord3d_t( (float)(rand() % K), (float)(rand() % K), (float)(rand() % K) ) + humanInWorld->startMP[10])
    );
